...
class EncryptStringClassVisitor(cv:ClassVisitor) : ClassVisitor(Opcodes.ASM6,cv) {
    ...
    override fun visitField(access: Int, name: String, descriptor: String, signature: String?, value: Any?): FieldVisitor {
        ...
        JniMessPlugin.log("jniMess::visitField,access=$access,name=$name,descriptor=$descriptor,signature=$signature,value=$value")
