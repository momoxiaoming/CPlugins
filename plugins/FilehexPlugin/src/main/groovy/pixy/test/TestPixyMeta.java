...
//		Log.i("Start of metadata information:");
//		Log.i("Total number of metadata entries: {}", metadataMap.size());
		
		int i = 0;
		for(Map.Entry<MetadataType, Metadata> entry : metadataMap.entrySet()) {
			//
//			Log.i("Metadata entry {} - {}", i, entry.getKey());
...
//		Log.i("End of metadata information.");
...
//		Log.i(indent + entry.getKey() + (StringUtils.isNullOrEmpty(entry.getValue())? "" : ": " + entry.getValue()));
