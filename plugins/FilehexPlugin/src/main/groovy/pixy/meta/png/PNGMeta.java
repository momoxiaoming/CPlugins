...
//		Log.i("ICCProfile name: {}", profileName);
		 
		byte[] icc_profile = IOUtils.readFully(ii, 4096);
//		Log.i("ICCProfile length: {}", icc_profile.length);
...
//			Log.i("{} ({}) | {} bytes | 0x{} (CRC)", type.getName(), type.getAttribute(), length, Long.toHexString(chunk.getCRC()));
		}
