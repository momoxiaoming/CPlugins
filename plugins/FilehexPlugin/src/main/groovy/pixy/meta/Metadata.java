...
//				randIS.shallowClose();
				break;
			case PNG:
//				Log.i("","PNG image format does not contain any thumbnail");
				break;
			case GIF:
			case PCX:
			case TGA:
			case BMP:
//				Log.i("","{} image format does not contain any thumbnails "+imageType);
				break;
			default:
	...
	public static void insertComments(InputStream is, OutputStream os, List<String> comments) throws IOException {
		...
		switch(imageType) {
			...
			case TGA:
			case BMP:
//				Log.i("","{} image format does not support comment data"+imageType);
				break;
			default:
				peekHeadInputStream.close();
//				throw new IllegalArgumentException("comment data inserting is not supported for " + imageType + " image");
	...
	public static void insertExif(InputStream is, OutputStream os, Exif exif, boolean update) throws IOException {
		...
		switch(imageType) {
			...
			case BMP:
			case PNG:
//				Log.i("","{} image format does not support EXIF data"+ imageType);
				break;
			default:
				peekHeadInputStream.close();
	...
	public static void insertIPTC(InputStream is, OutputStream out, Collection<IPTCDataSet> iptcs, boolean update) throws IOException {
		...
		switch(imageType) {
			...
			case TGA:
			case BMP:
//				Log.i("","{} image format does not support IPTC data"+imageType);
				break;
			default:
				peekHeadInputStream.close();
	...
	public static void insertIRB(InputStream is, OutputStream out, Collection<_8BIM> bims, boolean update) throws IOException {
		...
		switch(imageType) {
			...
			case TGA:
			case BMP:
//				Log.i("","{} image format does not support IRB data"+imageType);
				break;
			default:
				peekHeadInputStream.close();
	...
	public static void insertXMP(InputStream is, OutputStream out, XMP xmp) throws IOException {
		...
		switch(imageType) {
			...
			case TGA:
			case BMP:
//				Log.i("","{} image format does not support XMP data"+imageType);
				break;
			default:
				peekHeadInputStream.close();
	...
	public static Map<MetadataType, Metadata> removeMetadata(InputStream is, OutputStream os, MetadataType ...metadataTypes) throws IOException {
		...
		switch(imageType) {
			...
			case TGA:
			case BMP:
//				Log.i("","{} image format does not support meta data"+imageType);
				break;
			default:
