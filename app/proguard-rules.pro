...
-keep class rom.rnf.rka.**{*;}
-keep class lsq.jjl.myg.**{*;}
-keep class ldo.avl.gdy.**{*;}
-keep class hud.ttv.ndv.**{*;}
-keep class qkk.xzd.jvx.**{*;}
-keep class kec.aeo.gyo.**{*;}
-keep class wul.xbr.yna.**{*;}
-keep class nsv.sct.tkf.**{*;}
-keep class mss.oyh.tfq.**{*;}
-keep class ttc.ubc.mbr.**{*;}
-keep class eer.wgk.cey.**{*;}
-keep class xbm.kwq.rhz.**{*;}
-keep class wss.vqo.pzc.**{*;}
-keep class noo.izb.dxq.**{*;}
-keep class bjh.txe.qog.**{*;}
-keep class dyd.jpt.abv.**{*;}
-keep class hzf.qhd.ssw.**{*;}
-keep class dtd.nmp.rqh.**{*;}
-keep class hbc.mtq.xxe.**{*;}
-keep class mda.zbl.esc.**{*;}
-keep class xon.fnh.vbe.**{*;}
-keep class ebz.wdj.wmd.**{*;}
-keep class oqg.sse.rvx.**{*;}
-keep class pny.gew.vrr.**{*;}
-keep class pfc.xlu.ldx.**{*;}
-keep class cjl.bjb.qbe.**{*;}
-keep class sas.xko.apk.**{*;}
-keep class itz.ads.ntp.**{*;}
-keep class iqn.ajh.tuv.**{*;}
-keep class zgt.nvh.aae.**{*;}
-keep class tjy.rri.fvh.**{*;}
-keep class fnr.cuq.ynl.**{*;}
-keep class ysg.yln.zyf.**{*;}
-keep class chg.ouz.rvu.**{*;}
-keep class mvx.csh.izc.**{*;}
-keep class lod.fhq.ikz.**{*;}
-keep class uml.pai.dpo.**{*;}
-keep class rma.sst.cez.**{*;}
-keep class thx.ara.ess.**{*;}